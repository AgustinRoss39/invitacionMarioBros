window.INVITATION_CONFIG = {
  ...
  characters: [
    { src: "assets/img/2.png", width: "min(86vw, 395px)", bottom: "-3px", translateX: "-50%" },
    { src: "assets/img/1.png", width: "min(88vw, 405px)", bottom: "-4px", translateX: "-50%" },
    { src: "assets/img/3.png", width: "min(101vw, 470px)", bottom: "-4px", translateX: "-50%" },
    { src: "assets/img/4.png", width: "min(100vw, 465px)", bottom: "-5px", translateX: "-50%" }
  ]
};
